...
import { withJavaCompareRoutes } from './with-java-compare/with-java-compare.routes';
import { MainViewComponent } from './common/main-view.component';

export const routes: Routes = [
  ...withJavaCompareRoutes,
  {
    path: '',
    ...
    children: [
      ...
      {
        path: 'long-distance',
        component: CommunicateWithLongDistanceComponent,
      },
